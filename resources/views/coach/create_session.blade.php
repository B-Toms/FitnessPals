            ...
            <div class="bg-white border border-gray-100 overflow-hidden shadow-sm sm: p-8">
                ...
                <form action="{{ route('coach.sessions.store') }}" method="POST" class="space-y-5 text-gray-900">
                    ...
                    <div>
                        ...
                        <select name="Sporta_veida_id" id="Sporta_veida_id" class="mt-1 block w-full border-gray-300 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 focus:ring-opacity-50 transition" required>
                    ...
                    <div>
                        ...
                        <select name="Tips" id="Tips" class="mt-1 block w-full border-gray-300 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 focus:ring-opacity-50 transition" required>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="date" name="Datums" id="Datums" min="{{ date('Y-m-d') }}" class="mt-1 block w-full border-gray-300 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 focus:ring-opacity-50 transition" required>
                        </div>

                        <div>
                            <label for="Laiks" class="block text-sm font-semibold text-gray-700">Sākuma laiks</label>
                            <input type="time" name="Laiks" id="Laiks" class="mt-1 block w-full border-gray-300 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 focus:ring-opacity-50 transition" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="Ilgums" id="Ilgums" min="15" value="60" class="mt-1 block w-full border-gray-300 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 focus:ring-opacity-50 transition" required>
                        </div>

                        <div>
                            <label for="Max_dalībnieku_skaits" class="block text-sm font-semibold text-gray-700">Maksimālais dalībnieku skaits</label>
                            <input type="number" name="Max_dalībnieku_skaits" id="Max_dalībnieku_skaits" min="1" value="10" class="mt-1 block w-full border-gray-300 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 focus:ring-opacity-50 transition" required>
                        </div>
                    </div>
