            ...
            <div class="bg-white border border-gray-200 shadow-sm p-8">
                <form action="{{ route('sessions.update', $session->Sesijas_id) }}" method="POST" class="space-y-5 text-gray-900">
                    ...
                    <div>
                        ...
                        <select name="Sporta_veida_id" class="w-full border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm" required>
                    ...
                    <div>
                        ...
                        <select name="Tips" class="w-full border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm" required>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="date" name="Datums" value="{{ old('Datums', $session->Datums) }}" class="w-full border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm" required>
                        ...
                        <div>
                            ...
                            <input type="time" name="Laiks" value="{{ old('Laiks', date('H:i', strtotime($session->Laiks))) }}" class="w-full border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm" required>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="Ilgums" value="{{ old('Ilgums', $session->Ilgums) }}" class="w-full border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm" required>
                        ...
                        <div>
                            ...
                            <input type="number" name="Max_dalibnieku_skaits" value="{{ old('Max_dalibnieku_skaits', $session->Max_dalībnieku_skaits) }}" class="w-full border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm" required>
                    ...
                    <div class="flex justify-end gap-3 pt-6 border-t border-gray-100 mt-6">
                        <a href="{{ route('coach.dashboard') }}" class="px-5 py-2.5 bg-gray-100 text-gray-700 text-sm font-semibold hover:bg-gray-200 transition">
                            {{ __('Atcelt') }}
                        </a>
                        <button type="submit" class="px-5 py-2.5 bg-emerald-600 text-white text-sm font-semibold hover:bg-emerald-700 shadow-sm transition">
