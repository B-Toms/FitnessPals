        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach($trainers as $trainer)
                    <div class="bg-white border border-gray-200 shadow-sm p-6 flex flex-col justify-between">
                        <div>
                            <div class="w-16 h-16 bg-slate-100 border border-gray-200 flex items-center justify-center text-2xl mb-4">
